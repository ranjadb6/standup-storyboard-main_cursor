...
export const RwtTaskRow = ({ task, onUpdate, onDelete, columnWidths }: RwtTaskRowProps) => {
    ...
    return (
        <div className="flex hover:bg-muted/50 transition-colors py-1 group">
            <div className="flex text-sm w-full">
                ...
                {/* Features */}
                <div className="px-4 py-3 border-r border-black/20 shrink-0" style={{ width: columnWidths.feature }}>
                    <textarea
                        ref={featureRef}
                        value={task.feature}
                ...
                {/* Start Date */}
                <div className="px-4 py-3 border-r border-black/20 shrink-0" style={{ width: columnWidths.startDate }}>
                    <DatePickerButton
                        date={task.startDate}
                ...
                {/* End Date */}
                <div className="px-4 py-3 border-r border-black/20 shrink-0" style={{ width: columnWidths.endDate }}>
                    <DatePickerButton
                        date={task.endDate}
